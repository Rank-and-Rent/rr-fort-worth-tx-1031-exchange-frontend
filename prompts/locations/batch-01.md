...
1) fort-worth — Fort Worth, TX  Layout: map-first
2) dallas — Dallas, TX  Layout: overview
3) arlington — Arlington, TX  Layout: focused
4) irving — Irving, TX  Layout: detailed
5) plano — Plano, TX  Layout: comparison
6) frisco — Frisco, TX  Layout: market
7) mckinney — McKinney, TX  Layout: map-first
